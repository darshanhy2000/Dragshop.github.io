...
const MyVerticallyCenteredModal = (props) => {
  ...
  const decNum = () => {
    if (count > 1) {
      ...
      alert('Sorry, Your Minimum Limit Reached');
      setCount(1);
    }
  };
  ...
  const addToCart = async (id) => {
    dispatch({ type: 'products/addToCart', payload: { id, color: selectedColor, quantity: count } });
    setShowAddToCart(false); // Hide the "Add to Cart" button after clicking
  };
                ...
                <div className="row">
                  ...
                  <div className="col-lg-7 col-md-6 col-sm-12 col-12">
                    <div className="modal_product_content_one">
                      ...
                      <h4>
                        ₹{props.data.price}.00{' '}
                        <del style={{ fontWeight: 400, color: 'gray' }}>₹{parseInt(props.data.price) + 17}.00</del>{' '}
                      </h4>
                        ...
                        <div className="product-variable-color">
                          ...
                          <label htmlFor="modal-product-color-green">
                            <input
                              ...
                              className="color-select"
                              type="radio"
                              defaultChecked={selectedColor === 'green'}
                      ...
                      {showAddToCart ? (
                        <a href="#!" className="theme-btn-one btn-black-overlay btn_sm" onClick={() => addToCart(props.data.id)}>
                          Add To Cart
                        </a>
                      ) : (
                        <form id="product_count_form_one">
                          <div className="product_count_one">
                            <div className="plus-minus-input">
                              <div className="theme-btn-one-button">
                            <button type="button" className="button" onClick={() => decNum(props.data.id)}>
                              ...
                              <div className="theme-btn-one-button">
                              <button type="button" className="button" onClick={() => incNum(props.data.id)}>
