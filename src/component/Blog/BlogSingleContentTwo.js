        ...
        <div className="blog_single_content">
          ...
          <div className="blog_single_widget">
            <div className="blog_single_date">
              <ul>
                <li>Sep, 28, 2023 - By <a href="#!">Hasinas Deos</a></li>
              </ul>
            </div>
            <div className="blog_single_first_Widget">
              <h2>Fit-Flare Dress</h2>
                <p>
                  Elevate your style with the Fit-Flare Dress. Mauris blandit aliquet elit,
                  ...
                  lacinia eget consectetur sed, convallis at tellus. Sed porttitor lectus
                  nibh.
                </p>
                <p>
                  Vivamus suscipit tortor eget felis porttitor volutpat. Curabitur aliquet
                  quam id dui posuere blandit. Cras ultricies ligula sed magna dictum
                  porta. Vivamus suscipit tortor eget felis porttitor volutpat. Nulla
                  porttitor accumsan tincidunt. Praesent sapien massa, convallis a
                ...
                <p>
                  ...
                  quam id dui posuere blandit. Donec rutrum congue leo eget malesuada.
                </p>
            </div>
